...
module.exports = function (client, options) {
	...
	function play(msg, suffix) {
		//if the user is not in a server than return
		if (msg.member == null) return msg.channel.sendMessage(wrap('I dont accept this command as a dm.'));
